...
class VariantSelects extends HTMLElement {
  constructor() {
    ...
    this.variantData = JSON.parse(this.variantRadios.querySelector('script[type="application/json"]').textContent);
    this.addEventListener('DOMContentLoaded', this.updateSizeOptions(this.variantData))
  ...
  onVariantChange() {
    ...
    this.displayOutOfStockNotification();
    this.updateSizeOptions(this.variantData)
    this.checkDynamicCheckout();
  ...
  checkDynamicCheckout() {
    ...
    const dynamicCheckout = document.querySelector('.dynamic-checkout__container')
  ...
  renderProductInfo() {
    fetch(`${this.dataset.url}?variant=${this.currentVariant.id}&section_id=${this.dataset.originalSection ? this.dataset.originalSection : this.dataset.section}`)
      ...
      .then((responseText) => {
        ...
        const comingSoonProduct = html.querySelector('#coming-soon-product span')
  ...
  initSwiper(className) {
    ...
    if(swiper) {
        new Swiper(swiper, {
          ...
          slidesPerView: 2,
          navigation: {
            nextEl: '.yml-swiper-next',
            prevEl: '.yml-swiper-prev',
          },
          breakpoints: {
            768: {
              slidesPerView: 4,
